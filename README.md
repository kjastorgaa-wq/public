...
* **Power BI**: Para el modelado de datos, creación de medidas en DAX y diseño de los tableros.
* **Power Query**: Para la limpieza y transformación del archivo original de denuncias (`.csv`).

## 📁 Archivos del Repositorio
* `Informe de Denuncas.pbix`: Archivo principal con el reporte visual.
